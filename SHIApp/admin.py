...
from .models import (Amenities, Builder, PropertyList, PropertyImages, UserContactData, UserResumeData, PropertyContact) #Importing the models from models.py file to register in the admin panel of django.
