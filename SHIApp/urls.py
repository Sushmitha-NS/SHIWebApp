...
from .views import (home, PropertyListing, PropertyView, IndividualProp, advfilt_properties, about,
                      blog, faq, testimonials, terms, loan_calculator, contact_us, carriers, ContactData, CarrierData, PropertyContactData, ExclusiveProperty, SmartSearch, TimeLine, compare_property, compare, HotPropertyView, UpcomingProperty, HomePageSlider) #these are the view function's that we are using to perform the operations.
...
urlpatterns = [
    ...
    path('upcomingproperties/', UpcomingProperty , name='upcomingproperties'),  #this will send the property details of upcoming properties into the homepage. 
    path('slider/', HomePageSlider , name='slider'),  #this will send the carousel images into the home page.
