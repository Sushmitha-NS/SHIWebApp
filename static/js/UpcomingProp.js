//listening to the page load to load the upcoming properties.
window.addEventListener('load', (e) => {
    ...
    let url = "/upcomingproperties/"; //url where we are sending the fetch API request.
    ...
    const PropertyContainer = document.getElementById('UpcomingPropertyContainer');  //Accessing the property element to insert the filtered properties in it.
                ...
                data.forEach(element => {
                    ...
                    html += `<div class="col-md-4 col-sm-6">
                        <div class="property_item bottom40">
                            <div class="image">
                                <img src="${element.Property_Image}" alt="listin" class="img-responsive" style="height:230px;">
                            <div class="property_meta">
                                <span><i class="fa fa-object-group"></i>${element.Project_Area}</span>
                                <span><i class="fa fa-bed"></i>1,2,3</span>
                                <span><i class="fa fa-bath"></i>1|2|3 Bathroom</span>
                            </div>
                        ...
                        <div class="proerty_content">
                            <div class="proerty_text">
                                <h3><a href="/${element.slug}/${element.Location}">${element.PropertyName}</a></h3>
